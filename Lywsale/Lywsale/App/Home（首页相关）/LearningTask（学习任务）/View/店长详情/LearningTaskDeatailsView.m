//
//  LearningTaskDeatailsView.m
//  Lywsale
//
//  Created by 黄锡凯 on 2018/10/27.
//  Copyright © 2018 黄锡凯. All rights reserved.
//

#import "LearningTaskDeatailsView.h"

@implementation LearningTaskDeatailsView
...
- (void)setupSubviews:(NSString *)title data:(NSArray *)data {
    ...
    UIImage *timeBgImg = [UIImage imageNamed:@"learning-timeBg"];
    UIButton *timeBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    timeBtn.size = timeBgImg.size;
    timeBtn.x = 15;
    timeBtn.titleLabel.font = [UIFont systemFontOfSize:14];
    [timeBtn setBackgroundImage:timeBgImg forState:UIControlStateNormal];
    [timeBtn setTitle:@"剩余 16 天" forState:UIControlStateNormal];
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, timeBtn.maxY + 15, bgView.width, 0)];
